...
<div class="body-content">
    <div class="module">
        <h1>Receptionist</h1>
        <form class="form" action="<%=request.getContextPath()%>/AddReceptionistServlet" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="alert alert-error"></div>

            <% LoadingServices retrieve = new LoadingServices();

                User user=  retrieve.getUserId();%>
            <input type="text" value="<%=user.getUserId() %>" name="username"  required />
